...
## SI：艦船用接近戦装備 / Ships Infight Equipment
...
歩兵用の剣です。攻撃力、扱いやすさともバランスのいい武器です。  
斧、格闘武器につよいです。  

### IWAX：歩兵用斧 / Infantry Axe
  
歩兵用の戦斧です。攻撃力は高いですが、扱いにくい武器です。  
槍、棍棒につよいです。  

### IWSP：歩兵用槍 / Infantry Spear
  
歩兵用の長槍です。攻撃力は普通で、非常に扱いやすい武器です。  
ただ、広い場所でしか振り回せないため、艦船内では使用できません。  
剣につよいです。  

### IWCL：歩兵用棍 / Infantry Club
  
歩兵用の棍棒、バットです。攻撃力は低いですが、扱いやすさはまあまあで、重装甲の歩兵に有効です。  
剣につよいです。  

### IWME：格闘武器 / Melee Wepon
  
歩兵用の格闘戦用武器です。攻撃力は普通で敵の懐に飛び込むため命中は高いですが、練度はいります。  
槍、棍棒につよいです。  

### IWFL：飛翔武器 / Flying Wepon
  
弓やクロスボウなどの飛び道具武器です。射撃するのに矢などの弾薬が必要です。  

### IWCT：戦闘端末 / Combat Terminal
  
歩兵用の小型戦闘端末です。近くを浮遊しながら、攻撃、防御、補助などをおこないます。  
...
歩兵用の盾です。盾部分を交換することができます。  

### IAAM：歩兵用鎧 / Infantry Armor
  
歩兵用の追加装甲です。装甲、動力性能があがります。  

### IAGN：歩兵手甲 / Infantry Gauntlet
  
歩兵用の手甲です。装甲や電子性能があがります。  

### IABT：歩兵用靴 / Infantry Boots
  
歩兵用の靴です。機動性能など移動力を補助します。  

### IANC：歩兵首飾 / Infantry Necklace
  
歩兵用の首飾です。電子性能、動力性能、機動性能など性能をサポートします。  
...
[目次へ戻る](#目次--table-of-contents) / [魔導防具](wizard/readme.md)  
