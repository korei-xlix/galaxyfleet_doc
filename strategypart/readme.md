...
<h1>～戦略パート仕様～</h1>  
<h2>～Strategy part specifications～</h2>  
...
* [基礎情報](#aBaseInfo)
  ...
  * [兵器の区分記号](#aUnitClassificationSymbol)
  * [兵器種類](#aUnitKind)

  * [装備品の区分記号](#aEquipClassificationSymbol)
  * [装備品種類](#aEquipKind)
...
<h1 id="aBaseInfo">基礎情報 / Game Base Info</h1>  

<h1 id="aParts">各パート / Parts</h1>  
...
* **WE：魔導装備**  
  **[Wizard Equipment]**  
  魔導兵器のみが扱える特殊な装備です。  
  魔導兵器の性能を向上させたり、支援機能を追加するためのパーツです。  
  魔導エネルギーで動作するため消耗がありません。  
...
<h1 id="aSquadron">戦隊 / Squadron</h1>  
...
<h1 id="aMaterial">資材 / Material</h1>  
...
<h1 id="aFacilities">施設 / Facilities</h1>  
...
<h1 id="aMainMenues">メイン画面構成 / Main menues</h1>  
...
<h1 id="aMainCommands">メインコマンド / Main Commands</h1>  
