# Galaxy Fleet：兵器仕様：汎用航空機

## Galaxy Fleet：Weapon Specifications：Multipurpose Aircraft
...
* [兵器種類：汎用航空機](/unit/readme.md#muml汎用航空機--multipurpose-aircraft)

* 兵器標準仕様
  * [MUML-FIG：汎用戦闘機](#muml-fig汎用戦闘機--multipurpose-fighter)
  ...
  * [MUML-REC：汎用偵察機](#muml-rec汎用偵察機--multipurpose-recommend-aircraft)
  * [MUML-ELW：汎用電戦機](#muml-elw汎用電戦機--multipurpose-electronic-support-aircraft)
  * [MUML-SMK：汎用哨戒機](#muml-smk汎用哨戒機--multipurpose-submarine-killer-aircraft)
  * [MUML-CAG：汎用輸送機](#muml-cag汎用輸送機--multipurpose-cargo-aircraft)
